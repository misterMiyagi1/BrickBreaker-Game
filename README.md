...
StartScreen          db '             ====================================================',0ah,0dh
    ...
    db '              ====================================================',0ah,0dh
    db '$',0ah,0dh
GameoverScreen           db '          ________________________________________________',0ah,0dh
    db '             ||                                                  ||',0ah,0dh                                        
    db '             ||               >> GAMEOVER <<                     ||',0ah,0dh
    db '             ||__________________________________________________||',0ah,0dh    
    db '$',0ah,0dh
...
UpdateStrings Proc  
    ...
    PrintText 1 , 30 , Disp_Hits
    PrintText 1 , 45 , Disp_lifes   
...
Speed Proc
    ...
    Gamespeed: Delay 1,0         ;Normal Life Hits<=5
    EndSpeed:
    ret
Speed ENDP
;==================================================
...
DrawInterface   Proc
    ...
    PrintText 1 , 30 , Disp_Hits
    PrintText 1 , 45 , Disp_lifes   
    PrintText 1 , 2 , GameTitle
    PrintText 0, 2, Instruction
    PrintText 1, 41,separate
    pop dx
    pop cx
    pop ax
    RET
